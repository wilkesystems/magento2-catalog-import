<?php
namespace WilkeSystems\CatalogImport\Console\Command;
 ...
 * Class ImportCommand
 *
 * @package WilkeSystems\CatalogImport\Console\Command
 */
class ImportCommand extends Command
{
    ...
    /**
     * @return \WilkeSystems\CatalogImport\Model\Import
     */
    protected function getImportModel()
    {
        $this->state->setAreaCode('adminhtml');
        return $this->objectManager->create('WilkeSystems\CatalogImport\Model\Import');
    }
}
